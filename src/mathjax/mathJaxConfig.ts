...
const MathJaxConfig = {
    TeX: {
        packages: ['base', 'ams', 'noundefined', 'boldsymbol', 'newcommand', 'amscd', 'action', 'bbox', 'cancel', 'enclose', 'extpfeil', 'html', 'braket', 'physics', 'unicode', 'verb', 'mhchem'], // extensions to use
